...
typedef AppraiseIconClick = void Function(int index);
...
/// selectedTags 所有选中标签的集合
/// input 自定义输入的内容
typedef AppraiseConfirmClick = void Function(
    int index, List<String> selectedTags, String input);

/// 点击关闭的回掉
typedef AppraiseCloseClickCallBack = void Function(BuildContext context);
